...
<nav className=" border-gray-200 dark:border-gray-600 ">
    <div className=" navbar  ">
        ...
        <button onClick={toggleMenu} data-collapse-toggle="mega-menu-full" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden dataCollapseToggle focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dataCollapseToggle dark:focus:ring-gray-600" aria-controls="mega-menu-full" aria-expanded="false">
         ...
         <div id="mega-menu-full" className={`items-center justify-between font-medium' flex' : 'hidden' 'bg-blue-500' : w-full md:flex md:w-auto md:order-1`}>
            <ul className="navbar-collapse   ">
                <li>
                    <a href="#" className="block py-2 px-3 text-gray-900 rounded dataCollapseToggle md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dataCollapseToggle dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">Home</a>
                </li>
                <li>
                    <a href="#" className="block py-2 px-3 text-gray-900 rounded dataCollapseToggle md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dataCollapseToggle dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">About us</a>
                </li>
                <li>
                    <button onClick={toggleMenu1}  id="mega-menu-full-dropdown-button" data-collapse-toggle="mega-menu-full-dropdown" className="flex items-center justify-between w-full py-2 px-3 text-gray-900 rounded md:w-auto dataCollapseToggle md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dataCollapseToggle dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Services <svg className="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4"/>
                ...
                <li>
                    <a href="../elearn" className="block py-2 px-3 text-gray-900 rounded dataCollapseToggle md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dataCollapseToggle dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">E_learning</a>
                </li>
                <li>
                    <a href="#" className="block py-2 px-3 text-gray-900 rounded dataCollapseToggle md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dataCollapseToggle dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Svagyan</a>
                </li>
                <li>
                    <a href="#" className="block py-2 px-3 text-gray-900 rounded dataCollapseToggle md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dataCollapseToggle dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">careers</a>
                </li>
                <li>
                    <a href="#" className="block py-2 px-3 text-gray-900 rounded dataCollapseToggle md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dataCollapseToggle dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Contact Us</a>
                </li>
            </ul>
    ...
    <div id="mega-menu-full-dropdown" className={`isMenuOpen2 mt-1 border-gray-200 shadow-sm ${isMenuOpen2? 'flex' : 'hidden'}  dark:border-gray-600`}>
        <div className="grid max-w-screen-xl  mx-auto text-gray-900 dark:text-white sm:grid-cols-2 md:px-6">
        <ul>
                <li>
    ...
    <div id="mega-menu-full-dropdown" className={`isMenuOpen1 mt-1 border-gray-200 shadow-sm ${isMenuOpen1? 'flex' : 'hidden'} border-y  dark:border-gray-600`}>
        <div className="grid d-flex max-w-screen-xl  mx-auto text-gray-900 dark:text-white sm:grid-cols-2 md:px-6">
            <ul>
                <li>
                    <a href="#" className="block p-3 rounded-lg dataCollapseToggle dataCollapseToggle">
                    <div className="font-semibold"><svg height="512" version="1.1" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg">
  			  	<path d="M472.875 184.021l-224-149.333c-5.374-3.583-12.376-3.583-17.75 0l-224 149.333c-4.451 2.967-7.125 7.963-7.125 13.312v149.333c0 5.35 2.674 10.346 7.125 13.312l224 149.333c2.687 1.792 5.781 2.688 8.875 2.688s6.188-0.896 8.875-2.688l224-149.333c4.451-2.967 7.125-7.963 7.125-13.312v-149.333c0-5.349-2.674-10.345-7.125-13.312zM240 327.438l-83.156-55.438 83.156-55.437 83.156 55.437-83.156 55.438zM256 188.771v-110.875l179.155 119.438-83.155 55.437-96-64zM224 188.771l-96 64-83.156-55.437 179.156-119.438v110.875zM99.156 272l-67.156 44.771v-89.541l67.156 44.77zM128 291.229l96 64v110.874l-179.156-119.436 83.156-55.438zM256 355.229l96-64 83.156 55.438-179.156 119.437v-110.875zM380.844 272l67.156-44.77v89.542l-67.156-44.772z"></path>
                 </svg> <a>3D ANIMATION</a></div>
